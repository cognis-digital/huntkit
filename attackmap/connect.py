"""Native cognis-connect emit for attackmap — forward findings to any platform.

Maps attackmap's JSON output to the canonical `Finding` and forwards it via
...
Usage:
    attackmap ... --format json | attackmap-emit --to stix
    attackmap-emit --to slack --url $WEBHOOK --dry-run < findings.json
"""
